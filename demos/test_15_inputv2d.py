## This DEMO is a 2D example [x,z] with input velocity and with one shot
#  and output the ray paths
# 
...
vel1d=vel.transpose().flatten(order='F');#first axis (vertical) is x, second is z
...
xe=x0+dx*10; #event location
ze=z0+dz*10; #receiver location
...
## trace one ray (source and receiver in grids)
