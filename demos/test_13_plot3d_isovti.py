...
plt.savefig('test_13_plot3d_isovti.png',format='png',dpi=300,bbox_inches='tight', pad_inches=0)
plt.savefig('test_13_plot3d_isovti.pdf',format='pdf',dpi=300,bbox_inches='tight', pad_inches=0)
